...
public class BuildingService {
    ...
    public BuildingResponse createBuilding(
        ...
        auditService.record(authentication.getName(), saved, "BUILDING", saved.getId(), "CREATE", java.util.Map.of("code", saved.getCode(), "name", saved.getName()));
    ...
    public BuildingResponse updateBuilding(
        ...
        Building saved = buildingRepository.save(building);
        auditService.record(authentication.getName(), saved, "BUILDING", saved.getId(), "UPDATE", java.util.Map.of("active", saved.isActive(), "code", saved.getCode()));
        return toResponse(saved);
    }
