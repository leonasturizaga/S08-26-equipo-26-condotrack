...
public class UnitService {
    ...
    public UnitResponse createUnit(
        ...
        auditService.record(authentication.getName(), building, "UNIT", saved.getId(), "CREATE", java.util.Map.of("unitNumber", saved.getUnitNumber()));
    ...
    public UnitResponse updateUnit(
        ...
        Unit saved = unitRepository.save(unit);
        auditService.record(authentication.getName(), building, "UNIT", saved.getId(), "UPDATE", java.util.Map.of("active", saved.isActive(), "unitNumber", saved.getUnitNumber()));
        return toResponse(saved);
    }
